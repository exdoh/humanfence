...
<html>
    ...
    <body onload="">
        ...
        <div id="content" class="main_content" style="display:none">
        	<div id="button_eng" class="button_eng">&nbsp;</div>
            <div id="button_thai" class="button_thai">&nbsp;</div>
        	...
        	<div id="info" class="info" style="display:none">
        		<div id="info_header" class="info_header"></div>
        		<textarea id="info_content" class="info_content"></textarea>
        	</div>
